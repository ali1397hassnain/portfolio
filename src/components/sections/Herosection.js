  ...
  return (
    ...
    >
      <div className="container">
        <div className="intro">
          <img src="images/avatar-1.svg" alt="Ali Hassnain" className="mb-4" />

          <h1 className="mb-2 mt-0">Ali Hassnain</h1>
          <p>
            I'm a{" "}
            <Typed
              strings={[
          ...
          <ul className="social-icons light list-inline mb-0 mt-4">
            <li className="list-inline-item">
              <a href="https://github.com/ali1397hassnain?tab=repositories" target="_blank" rel="noreferrer">
                <i className="fab fa-github"></i>
              </a>
            </li>
            <li className="list-inline-item">
              <a href="https://www.linkedin.com/in/alihassnainhere/" target="_blank" rel="noreferrer">
